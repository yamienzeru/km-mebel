...
<?foreach($arResult['SECTIONS'] as $arSection):?>
	...
	<div class="catalog_box" id="<? echo $this->GetEditAreaId($arSection['ID']); ?>">
		<a href="<?=$arSection['SECTION_PAGE_URL']?>" class="catalog_box_link">
			<div class="inner_wrap_catalog_box">
				<div class="hover_layer_catalog">
					<img src="<?=SITE_TEMPLATE_PATH?>/static/images/icon_eye.png"/>
				</div>
			<?if($arSection['PICTURE']):?>
				<img src="<?=ResizeImage($arSection['PICTURE'], 268, 217)?>" alt="<?=$arSection['NAME']?>"/>
			<?endif?>							
			</div>
			<div class="catalog_item_descr">
				<span class="catalog_item_name"><?=$arSection['NAME']?></span>
				<span class="catalog_item_quantity"><?=$arSection['ELEMENT_CNT']?></span>
			</div>
		</a>
	</div>	
<?endforeach?>
