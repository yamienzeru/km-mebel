<?if(!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)die();?>
	<div class="promo_slider_block">
		<div id="promo_slider"  class="flexslider">
			<?if(!empty($arResult["PROPERTIES"]["NEWPRODUCT"]["VALUE"])):?><span class="new_goods">new</span><?endif?>
			<?if($arResult["PROPERTIES"]["IS_HIT"]["VALUE"] == "Y"):?><span class="hits_goods">hit</span><?endif?>
		<?if(!empty($arResult["PROPERTIES"]["MORE_PHOTO"]["VALUE"])):?>
			<ul class="slides">
			<?foreach($arResult["PROPERTIES"]["MORE_PHOTO"]["VALUE"] as $photo):?>
				<li>
					<div class="promo_item">
						<img src="<?=ResizeImage($photo, 3*500, 500)?>" alt="">
					</div>
				</li>
			<?endforeach?>
			</ul>
	...
	<div class="responses_descriprtion_block">
		<div class="tabs_btns">
			<div class="tab_btn tab_btn_active">Описание</div>
			<div class="tab_btn">Отзывы</div>
		</div>
		<div class="tab_block tab_block_description tab_block_active ">
			<?if($arResult["DETAIL_TEXT_TYPE"] != "html"):?><p><?endif?><?=$arResult["DETAIL_TEXT"]?><?if($arResult["DETAIL_TEXT_TYPE"] != "html"):?></p><?endif?>
		</div>
		<div class="tab_block tab_block_responses">
